      ...
      >
        ...
        >
          <p style="font-size: 20px" class="text-secondary">
            <strong>REPORTES - LISTADO DE RETENCIONES APLICADAS</strong>
          </p>
        </div>
        <div
...
export default {
  ...
  mounted() {
    this.pdfPrint();
    this.$emit("changeTitle", "SCEN - Reportes - Listado de Retenciones Aplicadas", "");
  ...
  methods: {
    ...
    pdfPrint() {
      api
        .get(`/pdfreports/relacionRetenciones`, {
          headers: {
