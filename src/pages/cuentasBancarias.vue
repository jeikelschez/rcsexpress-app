  ...
  <q-page class="pagina q-pa-md">
          ...
          <q-form @submit="sendData()" class="q-gutter-md">
            <div class="row">
              <div class="col-md-12 col-xs-12">
                <q-input outlined v-model="form.nro_cuenta" label="Numero de Cuenta" hint="" @update:model-value="
                  form.nro_cuenta =
              ...
              <div class="col-md-5 col-xs-12">
                <q-select outlined v-model="form.flag_activa" label="Estatus" hint="" class="pcform" :options="estatus"
                  :rules="[(val) => this.$refs.rulesVue.isReqSelect(val, 'Requerido')|| '']" lazy-rules>
                  <template v-slot:prepend>
                    <q-icon name="rule" />
                  </template>
                </q-select>
              ...
              <div class="col-md-7 col-xs-12">
                <q-select outlined v-model="form.tipo_cuenta" label="Tipo de Cuenta" hint=""
                  :rules="[(val) => this.$refs.rulesVue.isReqSelect(val, 'Requerido')|| '']" :options="tipoDeCuenta"
                  lazy-rules>
                  <template v-slot:prepend>
                    <q-icon name="ballot" />
                  </template>
              ...
              <div class="col-md-12 col-xs-12">
                <q-input outlined v-model="form.firma_autorizada" label="Firma Autorizada" hint="" @update:model-value="
    ...
    <div class="q-pa-sm justify-center col-md-12 col-xl-12 col-lg-12 col-xs-12 col-sm-12">
      <div class="row q-pa-md">
        <div class="col-xs-12 text-secondary movilTitle" style="align-self: center; text-align: center">
        ...
        <div class="col-md-5 col-xs-12 col-sm-6 cardMargin selectMobile" style="align-self: center; text-align: center">
          <q-select rounded transition-show="flip-up" transition-hide="flip-down" :options="bancosSelected" @filter="
            (val, update, abort) =>
              filterArray(
                val,
                update,
          ...
          " use-input hide-selected fill-input input-debounce="0" option-label="nb_banco" option-value="id"
            v-model="selectedBanco" outlined standout label="Escoge un Banco" @update:model-value="
      ...
      <div class="q-pa-md q-gutter-y-md">
        <q-table :rows="cuentas" row-key="id" binary-state-sort :columns="columns" :separator="separator"
          :filter="filter" :loading="loading" style="width: 100%" :grid="$q.screen.xs" v-model:pagination="pagination">
          ...
          <template v-slot:body-cell-action="props">
            <q-td :props="props">
              ...
              <q-btn dense round flat color="primary" icon="delete" :disabled="this.allowOption(4)"
                @click="selected = props.row.id" @click.capture="cuentasDelete = true"></q-btn>
            </q-td>
          </template>
                  ...
                  <q-item v-for="col in props.cols" :key="col.name">
                    ...
                    <q-item-section side>
                      ...
                      <q-btn v-else-if="col.name === 'action'" dense round flat color="primary" icon="delete"
                        ...
                        @click.capture="cuentasDelete = true"></q-btn>
    ...
    <methods ref="methods" @get-Data="
      getDataCuentas(`/cuentas`, 'setData', 'cuentas')
    " @reset-Loading="resetLoading" @set-Data-Cuentas-Edit="setDataEdit" @set-Data-Init="setDataInit"
      @set-Data="setData" @set-Data-Edit="setDataEdit" @set-Data-Permisos="setDataPermisos"></methods>
