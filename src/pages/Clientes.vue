              ...
              >
                <q-card-section>
                  <div class="row">
                    ...
                    >
                      <h4 style="font-size: 20px" class="text-secondary"><strong>UBICACIÓN GEOGRAFICA</strong></h4>
                    </div>
                    <div class="col-md-4 col-xs-12">
                      <q-select
                        outlined
                ...
                <q-card-section>
                  <div class="row">
                    <div
                      ...
                      style="align-self: center; text-align: left; margin-top: -30px"
                    >
                      <h4 style="font-size: 20px" class="text-secondary"><strong>INFORMACIÓN RESPECTO A LA EMPRESA DE ENCOMIENDA</strong></h4>
                    </div>
                    <div class="col-md-6 col-xs-12">
                      <q-select
                        outlined
    ...
    <div class="row q-pa-sm justify-center">
      <div class="col-md-12 col-xl-12 col-lg-12 col-xs-12 col-sm-12">
        <div class="row">
          ...
          >
            <h4 style="font-size: 30px" class="text-secondary"><strong>MANTENIMIENTO - CLIENTES</strong></h4>
          </div>
...
export default {
  ...
  methods: {
    ...
    getDataIniciar() {
      ...
      api
        .get(`/agencias/${this.agenciaRef2}/roles`, this.axiosConfig)
        .then((res) => {
