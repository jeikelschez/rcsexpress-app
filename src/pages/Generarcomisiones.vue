        ...
        >
          ...
          >
            <p style="font-size: 20px" class="text-secondary">
              <strong>Administración - Generar Comisiones de Entrega</strong>
            </p>
          </div>
          <div
          ...
          >
          <q-toggle
            label="Múltiples Agencias"
            v-model="multiples_agencias"
          />
          </div>
        </div>
        <div
          ...
          >
            ...
            >
              <div class="row">
                ...
                <div class="col-md-2 col-xs-12" style="align-self: center; text-align: center">
