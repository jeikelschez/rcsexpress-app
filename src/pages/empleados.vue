  ...
  <q-page class="pagina q-pa-md">
          ...
          <q-form @submit="sendData" class="q-gutter-md">
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <q-input outlined v-model="form.nombre" label="Nombre de Empleado"
                  ...
                  hint="" class="pcform" lazy-rules @update:model-value="form.nombre = form.nombre.toUpperCase()">
              ...
              <div class="col-md-6 col-xs-12">
                <q-input outlined v-model="form.rif_empleado" label="RIF de Empleado"
              ...
              <div class="col-md-3 col-xs-12" style="margin-bottom: 15px">
                <q-checkbox size="lg" v-model="form.aplica_retencion" true-value="1" false-value="0"
                  style="font-size: 13px" label="¿APLICA RETENCIÓN?" />
              </div>

              <div class="col-md-9 col-xs-12">
                <q-input outlined v-model="form.porcentaje_retencion" label="Porcentaje Retención" v-money="money"
              ...
              <div class="col-md-6 col-xs-12">
                <q-input outlined v-model="form.periodo" label="Período"
              ...
              <div class="col-md-6 col-xs-12">
                <q-input outlined v-model="form.sueldo" label="Sueldo"
                  :rules="[(val) => this.$refs.rulesVue.isMax(val, 13, 'Maxima Cantidad') || '']" hint=""
    ...
    <div class="q-pa-sm justify-center">
      <div class="row q-pa-md justify-end">
        ...
        <div class="col-md-5 col-sm-7 col-xs-12 cardMargin selectMobile" style="align-self: center; text-align: center">
        ...
        <div class="col-md-2 col-sm-4 col-xs-12" style="text-align: center; align-self: center">
          <q-btn label="Añadir Empleado" rounded color="primary" @click="dialog = true" :disabled="this.allowOption(2)">
          </q-btn>
        </div>
      </div>
    ...
    <methods ref="methods" @get-Data="getData('/empleados', 'setData', 'datos')" @set-data="setData"
      @set-Data-Edit="setData" @reset-Loading="resetLoading" @set-Data-Permisos="setDataPermisos">
    </methods>
